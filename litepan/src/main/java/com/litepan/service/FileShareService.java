...
public interface FileShareService {
    ...
    void saveShareInfo(FileShare fileShare);

    void delFileShareBatch(String userId, String shareIds);

    SessionShareDTO checkShareCode(String shareId, String code);

    void checkRootFilePid(String userId, String fileId, String filePid);

    void saveShare(String curUserId, String shareUserId, String fileRootPid, String shareFileIds, String folderId);
}